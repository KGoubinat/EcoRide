...
$redirect = $_GET['redirect'] ?? 'accueil.php';
?>
<!DOCTYPE html>
<html lang="fr">
<head>
  ...
  <link rel="canonical" href="<?= htmlspecialchars(rtrim(BASE_URL,'/').'/connexion.php', ENT_QUOTES) ?>">
  ...
  <meta property="og:url" content="<?= htmlspecialchars(rtrim(BASE_URL,'/').'/connexion.php', ENT_QUOTES) ?>">
...
<main class="no-columns">
  <div class="login-container">
    ...
    <!-- Formulaire -->
    <form id="loginForm" action="../backend/handlers/connexion.php" method="POST" novalidate>
